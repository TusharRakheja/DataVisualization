...
Thanks to [arciel](https://github.com/arciel)'s help with fixing the bug, gravity is now working correctly with simple explicit Euler integration. Check out the 
experiments directory for tests (when up). 

As soon as I have spring force working correctly and for sure, I'll be able to determine reasonable constants K, eqL and G for the ForceDirected graph.
